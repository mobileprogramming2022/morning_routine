...
public class StudyInflationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button SAVE = findViewById(R.id.studySaveBtn);
        ...
        wakeTimeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new TimePickerDialog(StudyInflationActivity.this, studyWakeTimeSetListener, mHour_wake, mMinute_wake, false).show();
            }
        });
        ...
        sleepTimeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new TimePickerDialog(StudyInflationActivity.this, studySleepTimeSetListener, mHour_sleep, mMinute_sleep, false).show();
            }
        });
